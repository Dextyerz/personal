...
getgenv().userid = "870106984236609656"
getgenv().alts = {"Dexalts_mbhrx","Dexalts_9in9e", "Dexalts_a61ng", "Dexalts_fss4n", "Dexalts_jhhif"} 
getgenv().normalwebhook = "https://discord.com/api/webhooks/1166673773588647996/adIpnyKJ0sXJ6ZIpzAxJv1KDZJS6ICCrTrcrXj4-RITeIvSUTDNxzZohjJIPjzmS3YD0"
repeat wait() until game:IsLoaded()
if game.PlaceId == 15502339080 then
    loadstring(game:HttpGet("https://raw.githubusercontent.com/Dextyerz/personal/main/modified.lua"))()
else
